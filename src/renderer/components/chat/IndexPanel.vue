  ...
  <div class="IndexPanel" @click="reset($event)">
    ...
    <div class="panel-area">
      <div class="panel-box">
        ...
        <!-- <div class="message-banner col-md-8 col-sm-8 col-xs-8"> -->
...
import menuSup from '@/components/commonCops/Menusup.vue'
import pgColumn from '@/components/commonCops/PGColumn.vue'
